  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      ...
      <ul className="ml-1 mt-8 flex items-center">
        <Link className="mr-5 text-xs shrink-0" href={"https://github.com/safeerkhattak"} target="_blank" 
        ...
        <Link className="mr-5 text-xs shrink-0" href={"https://www.linkedin.com/in/safeer-ahmad-416b7720b/"} target="_blank" >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="#8892b0"
        ...
        <Link className="mr-5 text-xs shrink-0" href="mailto:safeerahmad5454@gmail.com" target="_blank">
          <svg
            width="24px"
            height="24px"
            viewBox="0 0 24 24"
